document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchData() {
        const res = await fetch('https://66df33ebde4426916ee3e209.mockapi.io/tareas')
        data = await res.json();
        return data;
    }
    ...
    async function addNewTask() {
        ...
        await fetch('https://66df33ebde4426916ee3e209.mockapi.io/tareas',{
            method: 'POST',
            headers:{
    ...
    async function botoncompletado(event){
        ...
        await fetch(`https://66df33ebde4426916ee3e209.mockapi.io/tareas/${id}`,{
            method:'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
