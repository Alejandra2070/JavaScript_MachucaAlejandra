class cajaUno extends HTMLElement{
    constructor(){
        super();
        this.innerHTML=`
        <div id="caja1">
            <h3>Live User Filter</h3>
            <p id="search">Search by name and/or location</p>
...
customElements.define('cajita-uno', cajaUno)

class cajaDos extends HTMLElement{
    constructor(){
        super();
        this.innerHTML=`
        <div id="caja2"></div>
...
customElements.define('cajita-dos', cajaDos)
